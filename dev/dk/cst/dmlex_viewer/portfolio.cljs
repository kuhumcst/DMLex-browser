(ns dk.cst.dmlex-viewer.portfolio
  "The runner of the scene workbench: npx shadow-cljs watch portfolio,
  then http://localhost:8001.

  The scenes live in dk.cst.dmlex-viewer.views-scenes and render into
  dev-resources/public/canvas.html, which gives each one the viewer's
